...
describe OpenWeather do
  ...
  context 'requesting information on a multiple weather location' do
    ...
    before(:all) do
      @openweather = OpenWeather.new.multiple_weather_cycle_service
      @openweather.get_multiple_cities_cycle('55.5', '37.5', '10')
    end

    it 'should return a string for message' do
      expect(@openweather.get_message).to be_kind_of(String)
    end
    ...
    it 'should return integer for count' do
      expect(@openweather.get_count).to be_kind_of(Integer)
    end
    ...
    it 'should return hash or nil for snow' do
      @openweather.get_list_snow.each do |c|
        expect(c).to be_kind_of(Hash).or be_nil
      end
    end
    ...
    it 'should return an integer for clouds all' do
      @openweather.get_clouds_all.each do |c|
